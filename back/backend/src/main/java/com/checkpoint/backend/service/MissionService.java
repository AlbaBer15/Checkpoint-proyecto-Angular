...
public class MissionService {
    ...
    // ============================================================
    //  ESTADÍSTICAS (lógica de negocio, no UI)
    // ============================================================

    /**
     * Calcula el XP total de misiones completadas.
     * ✅ Ejecutado en backend = siempre consistente.
     */
    ...
    /**
     * Cuenta cuántas misiones están pendientes.
     * ✅ Ejecutado en backend = siempre consistente.
     */
